...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: `bg-primary text-white shadow-md hover:bg-primary-hover active:bg-primary-active focus:ring-primary/30 ${
      isActive ? 'ring-2 ring-primary shadow-lg scale-105' : ''
    }`,
    secondary: `bg-secondary text-white shadow-md hover:bg-secondary-hover active:bg-secondary-active focus:ring-secondary/30 ${
